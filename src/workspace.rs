            ...
            div()
                ...
                .child(
                    div()
                        ...
                        .border_1()
                        .border_color(t.border)
                        .elevated(crate::elevation::Overlay::ThemePicker, t.shadow)
                        .p_2()
                        .flex()
                        .flex_col()
                        .child(
            ...
            div()
                ...
                .child(
                    div()
                        ...
                        .border_1()
                        .border_color(t.border)
                        .elevated(crate::elevation::Overlay::About, t.shadow)
                        .p_5()
                        .flex()
                        .flex_col()
                        .items_center()
                    ...
                    gpui::anchored()
                        ...
                        .child(
                            div()
                                ...
                                .border_1()
                                .border_color(t.border)
                                .elevated(crate::elevation::Overlay::ContextMenu, t.shadow)
                                .overflow_hidden()
                                .flex()
                                .flex_col()
                                .py_1()
            ...
            div()
                ...
                .child(
                    div()
                        ...
                        .border_1()
                        .border_color(t.border)
                        .elevated(crate::elevation::Overlay::Shortcuts, t.shadow)
                        .p_4()
                        .flex()
                        .flex_col()
                        .gap_4()
                    ...
                    div()
                        ...
                        .child(
                            div()
                                ...
                                .border_1()
                                .border_color(t.border)
                                .elevated(crate::elevation::Overlay::AppMenu, t.shadow)
                                .p_1()
                                .flex()
                                .flex_col()
                                .on_mouse_down(gpui::MouseButton::Left, |_, _, cx| {
                    ...
                    div()
                        ...
                        .child(
                            div()
                                ...
                                .border_1()
                                .border_color(t.border)
                                .elevated(crate::elevation::Overlay::ConsentPrompt, t.shadow)
                                .flex()
                                .flex_row()
                                .items_center()
                                .gap_3()
                    ...
                    div()
                        ...
                        .child(
                            div()
                                ...
                                .border_1()
                                .border_color(t.border)
                                .elevated(crate::elevation::Overlay::InstallConfirmation, t.shadow)
                                .flex()
                                .flex_row()
                                .items_center()
                                .gap_3()
