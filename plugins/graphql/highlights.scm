; GraphQL highlight queries, from the Helix editor project
; (helix-editor/helix, runtime/queries/graphql/highlights.scm, MPL-2.0),
; written against the bkegley/tree-sitter-graphql grammar (MIT).
