...
// The private CGS window-blur SPI that upstream declares here has been
// removed: App Store review rejects any binary referencing
// _CGSSetWindowBackgroundBlurRadius or _CGSMainConnectionID, even on a code
// path that cannot execute. It only ran on macOS 11 and earlier; SuperMD
// requires 12.0, where NSVisualEffectView (public) is used instead.
...
impl PlatformWindow for MacWindow {
    ...
    fn set_background_appearance(&self, background_appearance: WindowBackgroundAppearance) {
        ...
        unsafe {
            ...
            {
                // Upstream branched here on macOS < 12, using the private CGS
                // window-blur SPI. That arm is removed: it cannot execute at
                // our 12.0 deployment target, and referencing the symbol is
                // enough to fail App Store review. NSVisualEffectView is the
                // public equivalent and is what upstream already uses on 12+.
